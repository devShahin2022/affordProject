...
<nav class="navbar navbar-expand-lg bg-light">
    <div class="@if (Auth::user() && Auth::user()->role == 'superadmin') container-fluid @else  container  @endif d-flex flex-wrap">
      <a class="navbar-brand" href="#"><span style="color: #0d6efd;
font-weight: bold;
font-size: 30px;">AffordE<span style="color: red;">DU</span> </span><small style="font-size:12px;color:#0d6efd" >online platform</small></a>
      @if(Auth::user())
      <div>
