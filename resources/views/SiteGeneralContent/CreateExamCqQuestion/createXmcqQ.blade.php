                    ...
                    <div id="question_{{$loop->index+1}}" class="border border-dark my-2 p-2 border-rounded">
                        ...
                        <div>
                            <div class="py-2 px-1 d-flex justify-content-end flex-wrap">
                                ...
                                <a  href="{{ route('viewSingleCq', ['serial'=>($loop->index+1),"id"=>$eahCq->id]) }}" class="active nav-link me-2"><button title="click to view" type="submit" class="btn btn-transparent"><span class="badge text-bg-info">View</span></button></a>
                                <a  href="{{ route('viewSingleCqUpdate', ['serial'=>($loop->index+1),"id"=>$eahCq->id]) }}" class="active nav-link me-2"><button title="click to view" type="submit" class="btn btn-transparent"><span class="badge text-bg-info">Update</span></button></a>
                            </div>
