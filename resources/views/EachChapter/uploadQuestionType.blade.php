            ...
            <div class="col-md-5 mb-3">
               ...
               <form method="POST" action="{{route('storeCat')}}" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <span class=" mt-2 d-block">Current question category no</span>
                            <input name="currentCatNo" 
                            @if (sizeof($currentData)>0)
                                value="{{$currentData[0]->cat_no}}"
                            @else
                                value="1"
                            @endif
                   ...
                   <hr>
                    <div>
                        <span class=" mt-2 d-block">Title of quetion type</span>
                        <textarea class="form-control w-100" placeholder="Type your question type name..." name="titleOfQuestionType" id="">@if (sizeof($currentData)>0){{$currentData[0]->quesTypeTitle}}@endif</textarea>
